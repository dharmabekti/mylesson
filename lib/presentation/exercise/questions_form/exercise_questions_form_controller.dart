import 'package:mylesson/data/model/exercise_result.dart';
...
class ExerciseQuestionsFormController extends GetxController {
  ...
  void navigateToQuestionIndex(int index) {
    ...
    try {
      activeQuestionId =
          questionList.elementAt(activeQuestionIndex).questionId ?? '';
    } catch (e) {
      // Ignore
    }
    update();
  ...
  void updateAnswerToQuestion(
    ...
    if (questionAnswers.any((e) => e.questionId == questionId)) {
      int indexToUpdate =
          questionAnswers.indexWhere((e) => e.questionId == questionId);
    ...
    selectedAnswer = questionAnswers
